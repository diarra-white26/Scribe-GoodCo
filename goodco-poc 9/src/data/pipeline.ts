  ...
  stages: [
    {
      ...
      sources: [
        ...
        { id: 'src-template-library', label: 'Reply template library', detail: 'The known Tier-1 intents: password reset, account lockout, SSO re-provisioning, 2FA reset, seat transfer' },
      ],
      scripts: [
        {
