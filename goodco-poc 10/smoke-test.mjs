...
console.log('Path B shows the analyst dashboard label:', pathBHtml.includes('Analyst dashboard'));
console.log('Path B surfaces a recommended next step:', pathBHtml.includes('Recommended next step') && pathBHtml.includes('Verify identity by phone'));
console.log('Path B shows a drafted reply awaiting send, not already sent:', pathBHtml.includes('Drafted reply, ready to send') && pathBHtml.includes('no auto-send'));
...
console.log('Path B also opens with the same automated greeting:', pathBHtml.includes('Thank you for reaching out to GoodCo Support'));
