 ...
 * what the agent did (escalation reason), what it's handing off (account and
 * session context), what it recommends doing next, and a drafted reply
 * sitting ready for the analyst to review and send — mirroring the source
 * recommendation's own design ("agent reviews and clicks Send, no auto-send
 * in v1"), not a cold handoff.
 */
  ...
  return (
    <div className="rounded-lg border border-line-soft bg-panel overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.3fr_1fr] gap-4 p-4">
        <div className="space-y-2">
          <p className="mono text-[11.5px] tracking-[0.18em] uppercase text-ink-4">Customer conversation script</p>
          <p className="text-[12px] text-ink-4 italic -mt-1">
            Shown here as chat — the same script works as a phone call, text message, or email reply.
          </p>
          <ChatWidget headerName="Support chat" headerSubtitle="Escalated · awaiting Priya" statusColor="bg-amber">
        ...
        <div className="space-y-3">
          <div>
            <p className="mono text-[11px] tracking-[0.16em] uppercase text-ink-4 mb-1.5">Account &amp; session context</p>
          ...
          <div className="rounded-md border border-line-soft bg-stage-2 p-2.5">
            <p className="mono text-[11px] tracking-[0.16em] uppercase text-ink-4 mb-1.5">Drafted reply, ready to send</p>
            <p className="text-[13.5px] text-ink-2 leading-relaxed text-pretty bg-panel border border-line-soft rounded-md p-2.5">
              {escalated.realAgentReply}
            </p>
