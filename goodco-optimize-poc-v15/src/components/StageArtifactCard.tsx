  ...
  return (
    <div className="rounded-lg border border-line-soft bg-panel overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 pt-3 pb-2">
        <span className="mono text-[12px] tracking-[0.22em] uppercase text-ink-4">Classification output</span>
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-3 text-[14px]">
        ...
        {artifact.accountLookup.detail.map((d) => (
          <FieldPill key={d.label} label={d.label} value={d.value} />
        ))}
      ...
      <p className="text-[13px] text-ink-4 leading-snug text-pretty">
        {artifact.agentAction === 'escalated-tier-2'
          ? 'Routed to a Tier-2 analyst — full dashboard below.'
