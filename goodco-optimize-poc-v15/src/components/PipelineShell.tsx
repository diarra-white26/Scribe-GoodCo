  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-start">
      <div className="flex-1 min-w-0 flex flex-col">
        <div className="sticky top-0 z-10 bg-panel border-b border-line-soft px-6 py-3 flex items-center justify-between flex-wrap gap-2">
          <div>
      ...
      <div className="w-full md:w-[320px] flex-shrink-0 border-t md:border-t-0 md:border-l border-line-soft md:sticky md:top-0 md:max-h-screen md:overflow-y-auto">
        <ContextRail
