...
console.log('Path A shows the customer script label (no escalation card):', pathAHtml.includes('Customer automated conversation script') && !pathAHtml.includes('Why it escalated'));
...
console.log('Path B1 shows the analyst\'s decision and ticket close-out:', pathB1Html.includes('ticket close-out') && pathB1Html.includes('Final email sent') && pathB1Html.includes('Edited before sending'));
console.log('Path B1 ticket closes out with a status:', pathB1Html.includes('>Closed<') && pathB1Html.includes('security log'));
...
console.log('Path B2 surfaces a recommended next step:', pathB2Html.includes('Recommended next step') && pathB2Html.includes('Run a remote connectivity reset'));
...
console.log('Path B2 shows the analyst\'s decision and ticket close-out:', pathB2Html.includes('ticket close-out') && pathB2Html.includes('Final email sent') && pathB2Html.includes('Edited before sending'));
console.log('Path B2 ticket closes out with a status:', pathB2Html.includes('>Closed<') && pathB2Html.includes('Root cause flagged to Engineering'));
...
console.log('Path B1 chat is one continuous thread with a system divider:', pathB1Html.includes('Escalated to Priya, Tier-2 support'));
console.log('Path B2 chat is one continuous thread with a system divider:', pathB2Html.includes('Escalated to Priya, Tier-2 support'));
