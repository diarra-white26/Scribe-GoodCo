...
function FlipCard({
  ...
  return (
    <button
      ...
      className="relative flex-shrink-0 w-[196px] h-[140px] text-left [perspective:1200px] cursor-pointer group"
    >
      <div
      ...
      >
        ...
        >
          <p className="text-[12.5px] text-ink-2 leading-snug text-pretty">{step.detail}</p>
